        ...
        if (typeof message.content === "string") {
          ...
          message.content.forEach((contentPart: any) => {
            if (contentPart.type === "text") {
              ...
              tokenCount += encoding.encode(JSON.stringify(contentPart.input || {})).length;
            } else if (contentPart.type === "tool_result") {
              const content = typeof contentPart.content === "string" ? contentPart.content : JSON.stringify(contentPart.content || {});
